...
BEGIN
  ...
  INTO v_dias, v_recebido_mes, v_previsto_mes, v_atrasado_mes, v_qtd_recebimentos, v_qtd_previstos, v_qtd_atrasados
  FROM computado;
...
REVOKE ALL ON FUNCTION public.calendario_mensal(integer, integer) FROM PUBLIC;
